...
class App extends Component {
    ...
    componentDidMount() {
            ...
            images: [
                {
                    ...
                    imageDetails: {
                        ...
                        desc: 'It is a long established fact that a reader will be distracted by the readable content of layout.',
                        iso: '800 / 200',
                        cost: '£15',
                        type: 'portrait',
                    },
        ...
        window.addEventListener('scroll', () => {
            ...
            window.pageYOffset > headerHeight ? this.setState({ stickyNav: true }) : this.setState({ stickyNav: false })
            window.pageYOffset > window.innerHeight ? this.setState({ scrollTopBtn: true }) : this.setState({ scrollTopBtn: false })
        });
    }
    ...
    handleNavigation(itemClass) {
        ...
        const classIndex = findIndex(allClasses, (imageClass) => imageClass === itemClass);
    ...
    render() {
        const { images, navItem, stickyNav, scrollTopBtn, lightbox, index, url } = this.state;
